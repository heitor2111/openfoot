            ...
            {activeTab === 'escalacao' && (
              <div className='bg-base-100 border border-base-content/20 rounded-sm p-4'>
                ...
                <div className='flex flex-col lg:flex-row gap-4'>
                  {/* Campo visual */}
                  <div
                    className='flex-1 bg-green-800 rounded-lg p-4 flex flex-col gap-3 transition-shadow'
                  >
